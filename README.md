...
📸 Screenshots
(Add screenshots here showing: command usage, players in different voice groups, tab completion in action)
🤝 Contributing
...
🙏 Credits
Simple Voice Chat by Henkelmax for the amazing voice API
WorldGuard by EngineHub for region management
